...
public:
	...
	void compute_and_save_marching_cubes_mesh(const char* filename, Eigen::Vector3i res3d = Eigen::Vector3i::Constant(128), BoundingBox aabb = {}, float thresh = 2.5f, bool unwrap_it = false, bool invert_normals = true);
	...
	struct Nerf {
		...
		bool visualize_cameras = true;	// lhw
	...
	bool m_visualize_unit_cube = true; //lhw
